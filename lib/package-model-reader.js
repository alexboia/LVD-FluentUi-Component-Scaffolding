...
class ComponentPackageModelReader {
	...
	_promptForLibraryName(onReady) {
		this._userInput.question(`Libary name (default value: ${this._data.libraryName}) = `, (libraryName) => {
			onReady(libraryName);
		});
	}
	...
	_promptForLibraryNameDashed(onReady) {
		this._userInput.question(`Library name, dashed form (default value: ${this._data.libraryNameDashed}) = `, (libraryNameDashed) => {
